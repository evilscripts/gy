    ...
    var stateStr = '{$product_detail->state[1]}';

    if(stateStr != '') {

      var country = '{$product_detail->country[1]}';
...
{* <pre>{$product_detail|@print_r}</pre> *}
{* {$product_detail->state[1]} *}
...
<div id="product-informations" class="panel product-tab">
  ...
  {* Country *}
  {* <div class="form-group">
    <label class="control-label agile-col-md-3 agile-col-lg-3 agile-col-xl-3" for="country">
      <span>
        {l s='Country' mod='agilemultipleseller'}
      </span>
    </label>
    <div class="agile-col-md-7 agile-col-lg-5 agile-col-xl-5">
      {include file="$agilemultipleseller_views/templates/front/products/input_text_lang.tpl"
      languages=$languages
      input_value=$product->country
      input_name='country'
      }
    </div>
  </div> *}
{* <pre>{$countries|@print_r}</pre> *}
            ...
            <optgroup label="{$category['name_main']}">
              {if $category['child']|@count > 0}
                {foreach $category['child'] AS $cat}
                  <option {if $product->id_category_default == $cat['id_category']}selected="selected"{/if} value="{$cat['id_category']}">{$cat['name']}</option>
                {/foreach}
              {/if}
            </optgroup>
            {/foreach}
 ...
 {*  <div class="form-group">
  ...
  {* Options *}
  <div style="display:none" id="product_options" class="form-group" {if !$product->active}style="display:none"{/if} >
    <div class="col-lg-12">
      <div class="form-group">
...
<div class="form-group">
  ...
  <div class="form-group">
    <label class="control-label agile-col-md-3 agile-col-lg-3 agile-col-xl-3" for="address">
      <span>
        {l s='Location' mod='agilemultipleseller'}
      </span>
    </label>
    <div class="agile-col-md-7 agile-col-lg-5 agile-col-xl-5">
      {include file="$agilemultipleseller_views/templates/front/products/input_text_lang.tpl"
      languages=$languages
      input_value=$product->address
      input_name='address'
      }
    </div>
  </div>
  ...
  <div class="form-group">
    <label class="control-label agile-col-md-3 agile-col-lg-3 agile-col-xl-3" for="address2">
      <span>
        {l s='Location (Line 2)' mod='agilemultipleseller'}
      </span>
    </label>
    <div class="agile-col-md-7 agile-col-lg-5 agile-col-xl-5">
      {include file="$agilemultipleseller_views/templates/front/products/input_text_lang.tpl"
      languages=$languages
      input_value=$product->address2
      input_name='address2'
      }
    </div>
  </div>
      ...
      <div class="row">
        <div class="agile-col-sm-9 agile-col-md-9 agile-col-lg-9 agile-col-xl-9">
          <select id="id_country" name="country">
            {* {if $sellerinfo->language_count[{$k}] eq $country['name']} selected="selected"{/if} *}
            {* {if $product_detail->country[0] eq $country['name']} selected="selected"{/if} *}
            {foreach from=$countries key=k item=country}
                <option {if $product_detail->country[1] eq $country['name']} selected="selected"{/if}
                value="{$country['name']}">
                  {$country['name']}
                </option>
              {/foreach}
...
<div class="form-group">
    ...
    <div class=" agile-col-sm-7 agile-col-md-7 agile-col-lg-7 agile-col-xl-7">
      <div class="row">
        <div class="agile-col-sm-5 agile-col-md-4 agile-col-lg-3 agile-col-xl-2">
          <input type="text" id="longitude" name="longitude" class="form-control" value="{if isset($smarty.post.longitude)}{$smarty.post.longitude}{else}{if isset($product->longitude)}{$product->longitude|escape:'htmlall':'UTF-8'}{/if}{/if}" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class=" agile-col-sm-7 agile-col-md-7 agile-col-lg-7 agile-col-xl-7">
      <div class="row">
        <div class="agile-col-sm-5 agile-col-md-4 agile-col-lg-3 agile-col-xl-2">
          <input type="text" id="latitude" name="latitude" class="form-control" value="{if isset($smarty.post.latitude)}{$smarty.post.latitude}{else}{if isset($product->latitude)}{$product->latitude|escape:'htmlall':'UTF-8'}{/if}{/if}" />
        </div>
      </div>
    </div>
  </div>
    ...
    <div class=" agile-col-sm-9 agile-col-md-9 agile-col-lg-9 agile-col-xl-9">
      <div class="row">
        <div class="agile-col-sm-12 agile-col-md-12 agile-col-lg-12 agile-col-xl-12">
          {include file="$agilemultipleseller_views./templates/googlemap_2.tpl"}
        </div>
      </div>
    </div>
  </div>
...
$(document).ready(function() {
  ...
  $('#saveInfo').click(function() {
    alert("{l s='Please upload your image after saving information.' mod='agilemultipleseller'}");
  });
...
<div class="form-group agile-align-center">
    <button id="saveInfo" type="submit" class="agile-btn agile-btn-default" name="submitProduct" value="{l s='Save' mod='agilemultipleseller'}">
