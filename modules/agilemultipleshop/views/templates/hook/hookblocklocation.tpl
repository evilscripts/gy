...
<div id="shopbylocation_block_left" class="block blockmanufacturer">
	{if $location_level == "country" }
		<p class="title_block"><a href="{$link->getSellerLocationLink('', $location_level)}" title="{l s='Shop by Country' mod='agilemultipleshop'}">{l s='Shop by Country' mod='agilemultipleshop'}</a></p>
	{elseif $location_level == "state"}
		<p class="title_block"><a href="{$link->getSellerLocationLink('', $location_level)}" title="{l s='Shop by State' mod='agilemultipleshop'}">{l s='Shop by State' mod='agilemultipleshop'}</a></p>
	{elseif $location_level == "city"}
		<p class="title_block"><a href="{$link->getSellerLocationLink('', $location_level)}" title="{l s='Shop by City' mod='agilemultipleshop'}">{l s='Shop by City' mod='agilemultipleshop'}</a></p>
	{elseif $location_level == "sellertype"}
		<p class="title_block"><a href="{$link->getSellerLocationLink('', $location_level)}" title="{l s='Shop by Seller Type' mod='agilemultipleshop'}">{l s='Shop by Seller Type' mod='agilemultiplehop'}</a></p>
	{elseif $location_level == "custom"}
		<p class="title_block"><a href="{$link->getSellerLocationLink('', $location_level)}" title="{l s='Shop by' mod='agilemultipleshop'}&nbsp;{$location_custom_name}">{l s='Shop by' mod='agilemultipleshop'}&nbsp;{$location_custom_name}</a></p>
	{/if}
