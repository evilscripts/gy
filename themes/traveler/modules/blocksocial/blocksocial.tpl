...
<section id="social_block">
	<ul>
		{if $facebook_url != ''}
			...
			<li>
				<div class="fb-like" data-href="https://www.facebook.com/guiding.you.around.world" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
			</li>
		{/if}
		{if $twitter_url != ''}
			<li class="twitter">
