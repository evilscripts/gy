...
class BlockSearch extends Module
{
	...
	{
		if (!parent::install() || !$this->registerHook('top') || !$this->registerHook('header') || !$this->registerHook('displayMobileTopSiteMap') || !$this->registerHook('FrontSearch'))
			return false;
		return true;
	}
	...
	public function hookFrontSearch() {
