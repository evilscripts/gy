	...
	{if isset($id_cms_seller_terms) AND $id_cms_seller_terms >0}
		...
		<p class="clearfix">
				<span class="agile-term">
					<a href="http://guiding-you.co/content/15-guide-legal-notice?content_only=1" id="seller_terms" name="seller_terms" class="iframe">{l s='Seller Terms & conditions(read)' mod='agilemultipleseller'}</a>
				</span>
		</p>
	{/if}
	<center>
